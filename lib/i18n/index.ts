...
const en: T = {
  ...
  s1_cta_main: "Activate Trading Pilot  see it in action",
  ...
  s2_opt2_head: "I've tried trading before and it didn't go well  I lost money and got discouraged",
  s2_opt2_sub: "I still believe it works, I just didn't have the right approach",
  s2_opt3_head: "I don't have time to sit watching charts all day  I have a job, a family, a life",
  ...
  s3_footer: "No right or wrong here  just helps us show you what's actually relevant to you",
  ...
  s4_result_no_time: "This is exactly what Trading Pilot was built for. Zero charts to watch. Zero screen time required. You activate a strategy, set your risk level and trade size, and the bot handles entry, management, and exit  24/7 across 20+ instruments. Most users spend under 10 minutes a week reviewing their results.",
